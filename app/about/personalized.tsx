...
export default function Personalized() {
  ...
  return (
    <motion.main
      ...
      className="section-container mt-16 md:mt-0 md:h-screen relative flex flex-wrap-reverse md:flex-wrap items-center justify-center md:justify-between md:px-16 lg:px-32 xl:px-48 space-y-8 gap-4 md:gap-8"
    >
