...
function PrincipleCard({ number, title, subtitle, description, delay = 0 }: PrincipleProps) {
    ...
    return (
        <div
            ref={cardRef}
            className={`group relative overflow-hidden rounded-2xl p-[1px] transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                }`}
        >
            ...
            <div className="relative">
                ...
                {/* Description */}
                <p className="text-white/60 md:text-md">
                    {description}
                </p>
            </div>
        </div>
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                <div className="grid gap-16 md:grid-cols-2">
                    ...
                    <PrincipleCard
                        ...
                        description="Our team combines decades of market expertise with cutting-edge financial technology. We continuously evolve our strategies, leveraging data-driven insights and innovative solutions to stay ahead of market trends and maximize opportunities."
                        delay={200}
                    />
                    <PrincipleCard
                        number="04"
                        ...
                        description="We're not just managing investments—we're building lasting relationships. Our approach focuses on sustainable, long-term growth that spans generations. We're here for every milestone, adapting strategies as your life and goals evolve."
                        delay={300}
                    />
                </div>
            </div>
