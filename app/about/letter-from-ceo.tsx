...
export default function LetterFromCeo() {
    ...
    return <div ref={ref} className='section-container my-64'><motion.main
        initial={{ opacity: 0 }}
    ...
    >
        ...
        <div className="w-full md:w-[45%] aspect-[279/333] md:aspect-[500/630] rounded-3xl overflow-hidden relative">
            <Image objectFit='cover' src={'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=800&h=800&fit=crop'} alt="hero" fill />
        </div>
    </motion.main>
    </div>
}