...
const translations: Record<string, { en: string; mn: string }> = {
  ...
  // About Page - Letter from Board Chairman
  "Letter from Board Chairman": {
    en: "Letter from Chairman of the Board",
    mn: "ТУЗ-ийн даргын мэндчилгээ",
  },
  "ceo.letter": {
  ...
  "ceo.title": {
    en: "Tenger Capital SC LLC Chairman of the Board",
    mn: "Тэнгэр Капитал ҮЦК ХХК-ийн ТУЗ-ийн дарга",
  },
  ...
  // Team member names
  "Gan-Erdene Sanjkhuyag": {
    en: "Gan-Erdene Sanjkhuyag",
    mn: "Cанжхуяг Ган-Эрдэнэ",
  },
