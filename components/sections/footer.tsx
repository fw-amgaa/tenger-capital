      ...
      <div className="relative flex flex-col gap-[2rem] px-[2rem] pt-[2rem] pb-[2rem] lg:gap-[3rem] lg:pt-[3rem]">
        ...
        <div className="bg-[#191919] leading-[1.4] text-xs rounded-[2rem] p-8 opacity-[0.8] text-[#f8f8f8CC])] [&amp;_p:not(:last-child)]:mb-[1em]">
          ...
          <p className="mb-2">
            ...
            /
            <Link className="underline" href="https://www.sipc.org/">
              SIPC
            </Link>
            ...
            &nbsp;page. You may check the background of these firms by
            visiting&nbsp;
            <Link className="underline" href="https://brokercheck.finra.org/">
              FINRA`s BrokerCheck
            </Link>
            .
          </p>
          ...
          <p className="mb-2">
            ...
            to fluctuate and may depreciate in value when redeemed. Liquidity
            and distributions are not guaranteed, and are subject to
            availability at the discretion of the Third Party Fund.
          </p>
          <p className="mb-2"></p>
          <p className="mb-2">
          ...
          <p className="mb-2"></p>
          <p className="mb-2">
            Investments with exposure to crypto assets are only suitable for
            investors who are willing to bear the risk of loss and experience
            sharp drawdowns, as they still carry inherent risk associated with
            cryptocurrencies.You are solely responsible for evaluating the
            merits and risks associated with the use of any information,
            materials, content, user content, or third party content provided
            before making any decisions based on such content. All investments
            carry risk, including the potential loss of principal. Investment
          ...
          <p className="mb-2">
            ...
            <Link
              className="underline"
              href="https://www.columntax.com/terms-of-use"
            >
              Terms of Use
            </Link>
            .
